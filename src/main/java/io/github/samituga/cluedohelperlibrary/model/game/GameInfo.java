...
public class GameInfo { // TODO: 2022-02-03 tests
  ...
  public Character character(String uuid) throws CardNotFoundException {
    return character(UUID.fromString(uuid));
  }

  public Character character(UUID uuid) throws CardNotFoundException {
  ...
  public Weapon weapon(String uuid) throws CardNotFoundException {
    return weapon(UUID.fromString(uuid));
  }

  public Weapon weapon(UUID uuid) throws CardNotFoundException {
  ...
  public Room room(String uuid) throws CardNotFoundException {
    return room(UUID.fromString(uuid));
  }

  public Room room(UUID uuid) throws CardNotFoundException {
  ...
  private <T extends BaseCard> T getCardWithUuid(List<T> cards, UUID uuid)
